...
test('getPositionQueryPlayer() should throw, with an unknown league and a valid difficulty in input', t => {
  const league = 'unknown'
  const difficulty = 'hard'

  const error = t.throws(() => getPositionQueryPlayer({ difficulty, league }))
